 ...
 * 
 */
@WebServiceClient(name = "FileServerWSService", targetNamespace = "http://ws.srv/", wsdlLocation = "http://localhost:8080/FileServerWs2?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/FileServerWs2?wsdl");
